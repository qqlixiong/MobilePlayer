package com.example.mobileplayer2.more.channel.activity;
...
import com.example.mobileplayer2.MyApplication;
...
import com.example.mobileplayer2.utils.NetworkConnectivityUtils;
 ...
 */
public class ChannelActivity extends BaseEngineEventHandlerActivity implements Config,IStatusBar{
    ...
    void setupRtcEngine() {
        ...
        // setup engine
        ((MyApplication) getApplication()).setRtcEngine(vendorKey);
        rtcEngine = ((MyApplication) getApplication()).getRtcEngine();
                    ...
                    alertDialog= new AlertDialog.Builder(ChannelActivity.this).setCancelable(false)
                            ...
                            .setPositiveButton(getString(R.string.error_confirm), new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    // Go to login
                                    Intent toLogin = new Intent(ChannelActivity.this, MoreActivity.class);
